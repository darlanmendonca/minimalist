...
var _inputNumberClass = require('./input-number.class.js');
...
describe('input-number', () => {
  ...
  test('should export a class', () => {
    (0, _chai.expect)(_inputNumberClass2.default).to.be.a('function');
  });

  test('should instanciate using a constructor', () => {
    const element = new _inputNumberClass2.default();
    (0, _chai.expect)(element).to.be.instanceof(_inputNumberClass2.default);
  });
  ...
  test('should have css class .mn-input-number', () => {
    (0, _chai.expect)(element).to.have.class('mn-input-number');
  });

  test('should listen attribute changes', () => {
    (0, _chai.expect)(_inputNumberClass2.default.observedAttributes).to.deep.equal(['label', 'value', 'name', 'placeholder', 'disabled', 'readonly', 'autofocus', 'currency', 'precision', 'min', 'max', 'percentage']);
  });
  ...
  test('should format percentage value', () => {
    ...
    element.value = 1;
    (0, _chai.expect)(element.value).to.be.equal(1);
    (0, _chai.expect)(element.inputChild).to.have.value('100');
    (0, _chai.expect)(element.mask).to.have.text('100 %');
    ...
    (0, _chai.expect)(element.value).to.be.equal(1);
    (0, _chai.expect)(element.inputChild).to.have.value('100,00');
    (0, _chai.expect)(element.mask).to.have.text('100,00 %');

    element.removeAttribute('percentage');
    (0, _chai.expect)(element.value).to.be.equal(100);
    (0, _chai.expect)(element.inputChild).to.have.value('100,00');
  });
  ...
  test('should increment value on ArrowUp', () => {
    ...
    element.inputChild.dispatchEvent(ArrowUp);
    (0, _chai.expect)(element).to.have.value(1.01);

    ArrowUp.altKey = true;
    element.inputChild.dispatchEvent(ArrowUp);
    (0, _chai.expect)(element).to.have.value(1.011);
  });
  ...
  test('should decrement value on ArrowDown', () => {
    ...
    element.inputChild.dispatchEvent(ArrowDown);
    (0, _chai.expect)(element).to.have.value(1.99);

    ArrowDown.altKey = true;
    element.inputChild.dispatchEvent(ArrowDown);
    (0, _chai.expect)(element).to.have.value(1.989);
  });
});
