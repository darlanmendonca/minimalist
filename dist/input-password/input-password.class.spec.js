...
var _inputPasswordClass = require('./input-password.class.js');
...
describe('input-password', () => {
  ...
  test('should export a class', () => {
    (0, _chai.expect)(_inputPasswordClass2.default).to.be.a('function');
  });

  test('should instanciate using a constructor', () => {
    const element = new _inputPasswordClass2.default();
    (0, _chai.expect)(element).to.be.instanceof(_inputPasswordClass2.default);
  });
  ...
  test('should have css class .mn-input-password', () => {
    (0, _chai.expect)(element).to.have.class('mn-input-password');
  });
