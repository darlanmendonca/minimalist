...
var _inputClass = require('./input.class.js');
...
describe('mn-input', () => {
  ...
  test('should export a class', () => {
    (0, _chai.expect)(_inputClass2.default).to.be.a('function');
  });

  test('should instanciate using a constructor', () => {
    const element = new _inputClass2.default();
    (0, _chai.expect)(element).to.be.instanceof(_inputClass2.default);
  });
  ...
  test('should listen attribute changes', () => {
    (0, _chai.expect)(_inputClass2.default.observedAttributes).to.deep.equal(['label', 'value', 'name', 'placeholder', 'disabled', 'readonly', 'maxlength', 'autocapitalize', 'autofocus', 'pattern']);
  });
