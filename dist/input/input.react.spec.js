...
describe('MnInput (React)', () => {
  ...
  test('should export a class', () => {
    (0, _chai.expect)(_inputReact2.default).to.be.an('function');
  });
...
function createComponent() {
  ...
  component = (0, _enzyme.shallow)(_react2.default.createElement(_inputReact2.default, null), { attachTo: window.app });
}