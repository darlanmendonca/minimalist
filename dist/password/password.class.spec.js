...
var _passwordClass = require('./password.class.js');
...
describe('mn-password', () => {
  ...
  test('should export a class', () => {
    (0, _chai.expect)(_passwordClass2.default).to.be.a('function');
  });

  test('should instanciate using a constructor', () => {
    const element = new _passwordClass2.default();
    (0, _chai.expect)(element).to.be.instanceof(_passwordClass2.default);
  });
  ...
  test('should have css class .mn-input', () => {
    (0, _chai.expect)(element).to.have.class('mn-input');
  });

  test('should have css class .mn-password', () => {
    (0, _chai.expect)(element).to.have.class('mn-password');
  });

  test('should listen attribute changes', () => {
    (0, _chai.expect)(_passwordClass2.default.observedAttributes).to.deep.equal(['label', 'value', 'name', 'placeholder', 'disabled', 'readonly', 'maxlength', 'autocapitalize', 'autofocus', 'pattern']);
  });
  ...
  test('should have a button child', () => {
    (0, _chai.expect)(element).to.have.a.property('buttonChild');
  });
  ...
  test('should toggle type between text/password', () => {
    (0, _chai.expect)(element.inputChild.type).to.be.equal('password');
    element.buttonChild.click();
    (0, _chai.expect)(element.inputChild.type).to.be.equal('text');
    element.buttonChild.click();
    (0, _chai.expect)(element.inputChild.type).to.be.equal('password');
  });
