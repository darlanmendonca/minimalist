...
describe('input-email', () => {
  ...
  test('should listen attribute changes', () => {
    (0, _chai.expect)(_inputEmailClass2.default.observedAttributes).to.deep.equal(['label', 'value', 'multiple', 'name', 'placeholder', 'disabled', 'readonly', 'maxlength', 'autocapitalize', 'autofocus', 'pattern']);
  });
